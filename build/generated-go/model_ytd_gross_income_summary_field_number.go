...
type _YTDGrossIncomeSummaryFieldNumber YTDGrossIncomeSummaryFieldNumber
...
func (o *YTDGrossIncomeSummaryFieldNumber) UnmarshalJSON(bytes []byte) (err error) {
	varYTDGrossIncomeSummaryFieldNumber := _YTDGrossIncomeSummaryFieldNumber{}

	if err = json.Unmarshal(bytes, &varYTDGrossIncomeSummaryFieldNumber); err == nil {
		*o = YTDGrossIncomeSummaryFieldNumber(varYTDGrossIncomeSummaryFieldNumber)
	}
