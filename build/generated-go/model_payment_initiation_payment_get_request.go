...
type _PaymentInitiationPaymentGetRequest PaymentInitiationPaymentGetRequest
...
func (o *PaymentInitiationPaymentGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPaymentInitiationPaymentGetRequest := _PaymentInitiationPaymentGetRequest{}

	if err = json.Unmarshal(bytes, &varPaymentInitiationPaymentGetRequest); err == nil {
		*o = PaymentInitiationPaymentGetRequest(varPaymentInitiationPaymentGetRequest)
	}
