...
type _SandboxPublicTokenCreateRequest SandboxPublicTokenCreateRequest
...
func (o *SandboxPublicTokenCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varSandboxPublicTokenCreateRequest := _SandboxPublicTokenCreateRequest{}

	if err = json.Unmarshal(bytes, &varSandboxPublicTokenCreateRequest); err == nil {
		*o = SandboxPublicTokenCreateRequest(varSandboxPublicTokenCreateRequest)
	}
