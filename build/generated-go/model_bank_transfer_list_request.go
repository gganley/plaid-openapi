...
type _BankTransferListRequest BankTransferListRequest
...
func (o *BankTransferListRequest) UnmarshalJSON(bytes []byte) (err error) {
	varBankTransferListRequest := _BankTransferListRequest{}

	if err = json.Unmarshal(bytes, &varBankTransferListRequest); err == nil {
		*o = BankTransferListRequest(varBankTransferListRequest)
	}
