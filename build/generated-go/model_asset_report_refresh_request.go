...
type _AssetReportRefreshRequest AssetReportRefreshRequest
...
func (o *AssetReportRefreshRequest) UnmarshalJSON(bytes []byte) (err error) {
	varAssetReportRefreshRequest := _AssetReportRefreshRequest{}

	if err = json.Unmarshal(bytes, &varAssetReportRefreshRequest); err == nil {
		*o = AssetReportRefreshRequest(varAssetReportRefreshRequest)
	}
