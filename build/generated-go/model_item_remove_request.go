...
type _ItemRemoveRequest ItemRemoveRequest
...
func (o *ItemRemoveRequest) UnmarshalJSON(bytes []byte) (err error) {
	varItemRemoveRequest := _ItemRemoveRequest{}

	if err = json.Unmarshal(bytes, &varItemRemoveRequest); err == nil {
		*o = ItemRemoveRequest(varItemRemoveRequest)
	}
