...
type _AssetReportCreateRequest AssetReportCreateRequest
...
func (o *AssetReportCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varAssetReportCreateRequest := _AssetReportCreateRequest{}

	if err = json.Unmarshal(bytes, &varAssetReportCreateRequest); err == nil {
		*o = AssetReportCreateRequest(varAssetReportCreateRequest)
	}
