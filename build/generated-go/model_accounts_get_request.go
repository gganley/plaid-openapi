...
type _AccountsGetRequest AccountsGetRequest
...
func (o *AccountsGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varAccountsGetRequest := _AccountsGetRequest{}

	if err = json.Unmarshal(bytes, &varAccountsGetRequest); err == nil {
		*o = AccountsGetRequest(varAccountsGetRequest)
	}
