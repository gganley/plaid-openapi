...
type _ItemGetRequest ItemGetRequest
...
func (o *ItemGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varItemGetRequest := _ItemGetRequest{}

	if err = json.Unmarshal(bytes, &varItemGetRequest); err == nil {
		*o = ItemGetRequest(varItemGetRequest)
	}
