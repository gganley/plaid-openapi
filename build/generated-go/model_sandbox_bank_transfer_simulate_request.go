...
type _SandboxBankTransferSimulateRequest SandboxBankTransferSimulateRequest
...
func (o *SandboxBankTransferSimulateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varSandboxBankTransferSimulateRequest := _SandboxBankTransferSimulateRequest{}

	if err = json.Unmarshal(bytes, &varSandboxBankTransferSimulateRequest); err == nil {
		*o = SandboxBankTransferSimulateRequest(varSandboxBankTransferSimulateRequest)
	}
