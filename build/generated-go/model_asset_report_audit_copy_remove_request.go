...
type _AssetReportAuditCopyRemoveRequest AssetReportAuditCopyRemoveRequest
...
func (o *AssetReportAuditCopyRemoveRequest) UnmarshalJSON(bytes []byte) (err error) {
	varAssetReportAuditCopyRemoveRequest := _AssetReportAuditCopyRemoveRequest{}

	if err = json.Unmarshal(bytes, &varAssetReportAuditCopyRemoveRequest); err == nil {
		*o = AssetReportAuditCopyRemoveRequest(varAssetReportAuditCopyRemoveRequest)
	}
