...
type _ProcessorTokenCreateRequest ProcessorTokenCreateRequest
...
func (o *ProcessorTokenCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varProcessorTokenCreateRequest := _ProcessorTokenCreateRequest{}

	if err = json.Unmarshal(bytes, &varProcessorTokenCreateRequest); err == nil {
		*o = ProcessorTokenCreateRequest(varProcessorTokenCreateRequest)
	}
