...
func (o *InstitutionsGetRequestOptions) UnmarshalJSON(bytes []byte) (err error) {
	varInstitutionsGetRequestOptions := _InstitutionsGetRequestOptions{}

	if err = json.Unmarshal(bytes, &varInstitutionsGetRequestOptions); err == nil {
		*o = InstitutionsGetRequestOptions(varInstitutionsGetRequestOptions)
	}
