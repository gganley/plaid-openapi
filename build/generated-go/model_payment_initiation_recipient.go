...
// PaymentInitiationRecipient Information about a payment recipient configured for the Payment Initiation product
...
func (o *PaymentInitiationRecipient) GetBacs() PaymentInitiationRecipientBacs {
	if o == nil || o.Bacs.Get() == nil {
		var ret PaymentInitiationRecipientBacs
		return ret
	}
	return *o.Bacs.Get()
}
...
// SetBacs gets a reference to the given NullablePaymentInitiationRecipientBacs and assigns it to the Bacs field.
