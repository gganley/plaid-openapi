...
type _PaymentInitiationPaymentTokenCreateRequest PaymentInitiationPaymentTokenCreateRequest
...
func (o *PaymentInitiationPaymentTokenCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPaymentInitiationPaymentTokenCreateRequest := _PaymentInitiationPaymentTokenCreateRequest{}

	if err = json.Unmarshal(bytes, &varPaymentInitiationPaymentTokenCreateRequest); err == nil {
		*o = PaymentInitiationPaymentTokenCreateRequest(varPaymentInitiationPaymentTokenCreateRequest)
	}
