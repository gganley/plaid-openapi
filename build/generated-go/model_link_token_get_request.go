...
type _LinkTokenGetRequest LinkTokenGetRequest
...
func (o *LinkTokenGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varLinkTokenGetRequest := _LinkTokenGetRequest{}

	if err = json.Unmarshal(bytes, &varLinkTokenGetRequest); err == nil {
		*o = LinkTokenGetRequest(varLinkTokenGetRequest)
	}
