...
type _YTDNetIncomeSummaryFieldNumber YTDNetIncomeSummaryFieldNumber
...
func (o *YTDNetIncomeSummaryFieldNumber) UnmarshalJSON(bytes []byte) (err error) {
	varYTDNetIncomeSummaryFieldNumber := _YTDNetIncomeSummaryFieldNumber{}

	if err = json.Unmarshal(bytes, &varYTDNetIncomeSummaryFieldNumber); err == nil {
		*o = YTDNetIncomeSummaryFieldNumber(varYTDNetIncomeSummaryFieldNumber)
	}
