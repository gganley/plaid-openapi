...
type _InvestmentsHoldingsGetRequest InvestmentsHoldingsGetRequest
...
func (o *InvestmentsHoldingsGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varInvestmentsHoldingsGetRequest := _InvestmentsHoldingsGetRequest{}

	if err = json.Unmarshal(bytes, &varInvestmentsHoldingsGetRequest); err == nil {
		*o = InvestmentsHoldingsGetRequest(varInvestmentsHoldingsGetRequest)
	}
