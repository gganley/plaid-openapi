...
type _LinkTokenCreateRequestDepositSwitch LinkTokenCreateRequestDepositSwitch
...
func (o *LinkTokenCreateRequestDepositSwitch) UnmarshalJSON(bytes []byte) (err error) {
	varLinkTokenCreateRequestDepositSwitch := _LinkTokenCreateRequestDepositSwitch{}

	if err = json.Unmarshal(bytes, &varLinkTokenCreateRequestDepositSwitch); err == nil {
		*o = LinkTokenCreateRequestDepositSwitch(varLinkTokenCreateRequestDepositSwitch)
	}
