...
type _SandboxProcessorTokenCreateRequestOptions SandboxProcessorTokenCreateRequestOptions
...
func (o *SandboxProcessorTokenCreateRequestOptions) UnmarshalJSON(bytes []byte) (err error) {
	varSandboxProcessorTokenCreateRequestOptions := _SandboxProcessorTokenCreateRequestOptions{}

	if err = json.Unmarshal(bytes, &varSandboxProcessorTokenCreateRequestOptions); err == nil {
		*o = SandboxProcessorTokenCreateRequestOptions(varSandboxProcessorTokenCreateRequestOptions)
	}
