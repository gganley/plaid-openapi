...
type _IncomeVerificationSummaryGetRequest IncomeVerificationSummaryGetRequest
...
func (o *IncomeVerificationSummaryGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varIncomeVerificationSummaryGetRequest := _IncomeVerificationSummaryGetRequest{}

	if err = json.Unmarshal(bytes, &varIncomeVerificationSummaryGetRequest); err == nil {
		*o = IncomeVerificationSummaryGetRequest(varIncomeVerificationSummaryGetRequest)
	}
