...
type _IncomeVerificationDocumentsDownloadRequest IncomeVerificationDocumentsDownloadRequest
...
func (o *IncomeVerificationDocumentsDownloadRequest) UnmarshalJSON(bytes []byte) (err error) {
	varIncomeVerificationDocumentsDownloadRequest := _IncomeVerificationDocumentsDownloadRequest{}

	if err = json.Unmarshal(bytes, &varIncomeVerificationDocumentsDownloadRequest); err == nil {
		*o = IncomeVerificationDocumentsDownloadRequest(varIncomeVerificationDocumentsDownloadRequest)
	}
