...
type _ItemImportRequestOptions ItemImportRequestOptions
...
func (o *ItemImportRequestOptions) UnmarshalJSON(bytes []byte) (err error) {
	varItemImportRequestOptions := _ItemImportRequestOptions{}

	if err = json.Unmarshal(bytes, &varItemImportRequestOptions); err == nil {
		*o = ItemImportRequestOptions(varItemImportRequestOptions)
	}
