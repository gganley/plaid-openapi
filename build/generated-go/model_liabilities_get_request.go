...
type _LiabilitiesGetRequest LiabilitiesGetRequest
...
func (o *LiabilitiesGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varLiabilitiesGetRequest := _LiabilitiesGetRequest{}

	if err = json.Unmarshal(bytes, &varLiabilitiesGetRequest); err == nil {
		*o = LiabilitiesGetRequest(varLiabilitiesGetRequest)
	}
