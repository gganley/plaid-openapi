...
// GetWireRouting returns the WireRouting field value if set, zero value otherwise (both if not set or set to explicit null).
...
// SetWireRouting gets a reference to the given NullableString and assigns it to the WireRouting field.
