...
type _AssetReportGetRequest AssetReportGetRequest
...
func (o *AssetReportGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varAssetReportGetRequest := _AssetReportGetRequest{}

	if err = json.Unmarshal(bytes, &varAssetReportGetRequest); err == nil {
		*o = AssetReportGetRequest(varAssetReportGetRequest)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "include_insights")
