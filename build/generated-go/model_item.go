...
// GetConsentExpirationTime returns the ConsentExpirationTime field value if set, zero value otherwise (both if not set or set to explicit null).
...
// GetConsentExpirationTimeOk returns a tuple with the ConsentExpirationTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
func (o *Item) HasConsentExpirationTime() bool {
	if o != nil && o.ConsentExpirationTime.IsSet() {
		return true
	}
...
// SetConsentExpirationTime gets a reference to the given NullableString and assigns it to the ConsentExpirationTime field.
...
func (o Item) MarshalJSON() ([]byte, error) {
	...
	if o.ConsentExpirationTime.IsSet() {
