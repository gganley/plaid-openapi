...
type _LinkTokenCreateRequestPaymentInitiation LinkTokenCreateRequestPaymentInitiation
...
func (o *LinkTokenCreateRequestPaymentInitiation) UnmarshalJSON(bytes []byte) (err error) {
	varLinkTokenCreateRequestPaymentInitiation := _LinkTokenCreateRequestPaymentInitiation{}

	if err = json.Unmarshal(bytes, &varLinkTokenCreateRequestPaymentInitiation); err == nil {
		*o = LinkTokenCreateRequestPaymentInitiation(varLinkTokenCreateRequestPaymentInitiation)
	}
