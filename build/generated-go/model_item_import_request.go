...
type _ItemImportRequest ItemImportRequest
...
func (o *ItemImportRequest) UnmarshalJSON(bytes []byte) (err error) {
	varItemImportRequest := _ItemImportRequest{}

	if err = json.Unmarshal(bytes, &varItemImportRequest); err == nil {
		*o = ItemImportRequest(varItemImportRequest)
	}
