...
func (o *ProductStatusBreakdown) GetRefreshInterval() string {
	if o == nil || o.RefreshInterval.Get() == nil {
		var ret string
		return ret
	}
...
// SetRefreshInterval gets a reference to the given NullableString and assigns it to the RefreshInterval field.
...
func (o ProductStatusBreakdown) MarshalJSON() ([]byte, error) {
	...
	if o.RefreshInterval.IsSet() {
		toSerialize["refresh_interval"] = o.RefreshInterval.Get()
	}
