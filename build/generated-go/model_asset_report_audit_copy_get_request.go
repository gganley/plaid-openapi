...
type _AssetReportAuditCopyGetRequest AssetReportAuditCopyGetRequest
...
func (o *AssetReportAuditCopyGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varAssetReportAuditCopyGetRequest := _AssetReportAuditCopyGetRequest{}

	if err = json.Unmarshal(bytes, &varAssetReportAuditCopyGetRequest); err == nil {
		*o = AssetReportAuditCopyGetRequest(varAssetReportAuditCopyGetRequest)
	}
