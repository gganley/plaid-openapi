...
type _BankTransferEventSyncRequest BankTransferEventSyncRequest
...
func (o *BankTransferEventSyncRequest) UnmarshalJSON(bytes []byte) (err error) {
	varBankTransferEventSyncRequest := _BankTransferEventSyncRequest{}

	if err = json.Unmarshal(bytes, &varBankTransferEventSyncRequest); err == nil {
		*o = BankTransferEventSyncRequest(varBankTransferEventSyncRequest)
	}
