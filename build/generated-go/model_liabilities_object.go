...
type LiabilitiesObject struct {
	...
	Credit []CreditCardLiability `json:"credit,omitempty"`
...
// SetCredit gets a reference to the given []CreditCardLiability and assigns it to the Credit field.
...
// GetMortgageOk returns a tuple with the Mortgage field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetMortgage gets a reference to the given []MortgageLiability and assigns it to the Mortgage field.
...
// SetStudent gets a reference to the given []StudentLoan and assigns it to the Student field.
