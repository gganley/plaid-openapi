...
type _ProcessorApexProcessorTokenCreateRequest ProcessorApexProcessorTokenCreateRequest
...
func (o *ProcessorApexProcessorTokenCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varProcessorApexProcessorTokenCreateRequest := _ProcessorApexProcessorTokenCreateRequest{}

	if err = json.Unmarshal(bytes, &varProcessorApexProcessorTokenCreateRequest); err == nil {
		*o = ProcessorApexProcessorTokenCreateRequest(varProcessorApexProcessorTokenCreateRequest)
	}
