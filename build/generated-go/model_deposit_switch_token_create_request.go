...
type _DepositSwitchTokenCreateRequest DepositSwitchTokenCreateRequest
...
func (o *DepositSwitchTokenCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varDepositSwitchTokenCreateRequest := _DepositSwitchTokenCreateRequest{}

	if err = json.Unmarshal(bytes, &varDepositSwitchTokenCreateRequest); err == nil {
		*o = DepositSwitchTokenCreateRequest(varDepositSwitchTokenCreateRequest)
	}
