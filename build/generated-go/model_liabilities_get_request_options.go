...
type _LiabilitiesGetRequestOptions LiabilitiesGetRequestOptions
...
func (o *LiabilitiesGetRequestOptions) UnmarshalJSON(bytes []byte) (err error) {
	varLiabilitiesGetRequestOptions := _LiabilitiesGetRequestOptions{}

	if err = json.Unmarshal(bytes, &varLiabilitiesGetRequestOptions); err == nil {
		*o = LiabilitiesGetRequestOptions(varLiabilitiesGetRequestOptions)
	}
