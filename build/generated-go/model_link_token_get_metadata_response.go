...
type LinkTokenGetMetadataResponse struct {
	...
	InitialProducts *[]Products `json:"initial_products,omitempty"`
...
// GetInitialProducts returns the InitialProducts field value if set, zero value otherwise.
func (o *LinkTokenGetMetadataResponse) GetInitialProducts() []Products {
	if o == nil || o.InitialProducts == nil {
		var ret []Products
		return ret
	}
...
// GetInitialProductsOk returns a tuple with the InitialProducts field value if set, nil otherwise
...
// SetInitialProducts gets a reference to the given []Products and assigns it to the InitialProducts field.
