...
type _SandboxItemSetVerificationStatusRequest SandboxItemSetVerificationStatusRequest
...
func (o *SandboxItemSetVerificationStatusRequest) UnmarshalJSON(bytes []byte) (err error) {
	varSandboxItemSetVerificationStatusRequest := _SandboxItemSetVerificationStatusRequest{}

	if err = json.Unmarshal(bytes, &varSandboxItemSetVerificationStatusRequest); err == nil {
		*o = SandboxItemSetVerificationStatusRequest(varSandboxItemSetVerificationStatusRequest)
	}
