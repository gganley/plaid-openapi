...
type _IdentityGetRequest IdentityGetRequest
...
func (o *IdentityGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varIdentityGetRequest := _IdentityGetRequest{}

	if err = json.Unmarshal(bytes, &varIdentityGetRequest); err == nil {
		*o = IdentityGetRequest(varIdentityGetRequest)
	}
