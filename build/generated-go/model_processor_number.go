...
// SetAch gets a reference to the given NullableNumbersACH and assigns it to the Ach field.
...
// SetEft gets a reference to the given NullableNumbersEFT and assigns it to the Eft field.
...
// SetInternational gets a reference to the given NullableNumbersInternational and assigns it to the International field.
...
// SetBacs gets a reference to the given NullableNumbersBACS and assigns it to the Bacs field.
