...
// AccountSubtype See the [Account type schema](/docs/api/accounts/#account-type-schema) for a full listing of account types and corresponding subtypes.
...
func (v *AccountSubtype) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range []AccountSubtype{"401a", "401k", "403B", "457b", "529", "brokerage", "cash isa", "education savings account", "gic", "health reimbursement arrangement", "hsa", "isa", "ira", "lif", "lira", "lrif", "lrsp", "non-taxable brokerage account", "other", "prif", "rdsp", "resp", "rlif", "rrif", "pension", "profit sharing plan", "retirement", "roth", "roth 401k", "rrsp", "sep ira", "simple ira", "sipp", "stock plan", "thrift savings plan", "tfsa", "trust", "ugma", "utma", "variable annuity", "credit card", "paypal", "cd", "checking", "savings", "money market", "prepaid", "auto", "commercial", "construction", "consumer", "home", "home equity", "loan", "mortgage", "overdraft", "line of credit", "student", "cash management", "keogh", "mutual fund", "recurring", "rewards", "safe deposit", "sarsep", "null"} {
