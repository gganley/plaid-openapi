...
type _ProcessorIdentityGetRequest ProcessorIdentityGetRequest
...
func (o *ProcessorIdentityGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varProcessorIdentityGetRequest := _ProcessorIdentityGetRequest{}

	if err = json.Unmarshal(bytes, &varProcessorIdentityGetRequest); err == nil {
		*o = ProcessorIdentityGetRequest(varProcessorIdentityGetRequest)
	}
