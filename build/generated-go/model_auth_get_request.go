...
type _AuthGetRequest AuthGetRequest
...
func (o *AuthGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varAuthGetRequest := _AuthGetRequest{}

	if err = json.Unmarshal(bytes, &varAuthGetRequest); err == nil {
		*o = AuthGetRequest(varAuthGetRequest)
	}
