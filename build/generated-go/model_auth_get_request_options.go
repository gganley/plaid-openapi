...
type _AuthGetRequestOptions AuthGetRequestOptions
...
func (o *AuthGetRequestOptions) UnmarshalJSON(bytes []byte) (err error) {
	varAuthGetRequestOptions := _AuthGetRequestOptions{}

	if err = json.Unmarshal(bytes, &varAuthGetRequestOptions); err == nil {
		*o = AuthGetRequestOptions(varAuthGetRequestOptions)
	}
