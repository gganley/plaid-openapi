...
type _BankTransferEventListRequest BankTransferEventListRequest
...
func (o *BankTransferEventListRequest) UnmarshalJSON(bytes []byte) (err error) {
	varBankTransferEventListRequest := _BankTransferEventListRequest{}

	if err = json.Unmarshal(bytes, &varBankTransferEventListRequest); err == nil {
		*o = BankTransferEventListRequest(varBankTransferEventListRequest)
	}
