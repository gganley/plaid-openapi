...
type _AssetReportRemoveRequest AssetReportRemoveRequest
...
func (o *AssetReportRemoveRequest) UnmarshalJSON(bytes []byte) (err error) {
	varAssetReportRemoveRequest := _AssetReportRemoveRequest{}

	if err = json.Unmarshal(bytes, &varAssetReportRemoveRequest); err == nil {
		*o = AssetReportRemoveRequest(varAssetReportRemoveRequest)
	}
