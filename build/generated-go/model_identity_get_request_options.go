...
type _IdentityGetRequestOptions IdentityGetRequestOptions
...
func (o *IdentityGetRequestOptions) UnmarshalJSON(bytes []byte) (err error) {
	varIdentityGetRequestOptions := _IdentityGetRequestOptions{}

	if err = json.Unmarshal(bytes, &varIdentityGetRequestOptions); err == nil {
		*o = IdentityGetRequestOptions(varIdentityGetRequestOptions)
	}
