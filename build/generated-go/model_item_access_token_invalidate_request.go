...
type _ItemAccessTokenInvalidateRequest ItemAccessTokenInvalidateRequest
...
func (o *ItemAccessTokenInvalidateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varItemAccessTokenInvalidateRequest := _ItemAccessTokenInvalidateRequest{}

	if err = json.Unmarshal(bytes, &varItemAccessTokenInvalidateRequest); err == nil {
		*o = ItemAccessTokenInvalidateRequest(varItemAccessTokenInvalidateRequest)
	}
