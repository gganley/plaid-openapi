...
type _InstitutionsGetRequest InstitutionsGetRequest
...
func (o *InstitutionsGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varInstitutionsGetRequest := _InstitutionsGetRequest{}

	if err = json.Unmarshal(bytes, &varInstitutionsGetRequest); err == nil {
		*o = InstitutionsGetRequest(varInstitutionsGetRequest)
	}
