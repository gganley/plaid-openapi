...
type _AssetReportCreateRequestOptions AssetReportCreateRequestOptions
...
func (o *AssetReportCreateRequestOptions) UnmarshalJSON(bytes []byte) (err error) {
	varAssetReportCreateRequestOptions := _AssetReportCreateRequestOptions{}

	if err = json.Unmarshal(bytes, &varAssetReportCreateRequestOptions); err == nil {
		*o = AssetReportCreateRequestOptions(varAssetReportCreateRequestOptions)
	}
