...
type _TransactionsGetRequest TransactionsGetRequest
...
func (o *TransactionsGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varTransactionsGetRequest := _TransactionsGetRequest{}

	if err = json.Unmarshal(bytes, &varTransactionsGetRequest); err == nil {
		*o = TransactionsGetRequest(varTransactionsGetRequest)
	}
