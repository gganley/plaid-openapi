...
type _EmployersSearchRequest EmployersSearchRequest
...
func (o *EmployersSearchRequest) UnmarshalJSON(bytes []byte) (err error) {
	varEmployersSearchRequest := _EmployersSearchRequest{}

	if err = json.Unmarshal(bytes, &varEmployersSearchRequest); err == nil {
		*o = EmployersSearchRequest(varEmployersSearchRequest)
	}
