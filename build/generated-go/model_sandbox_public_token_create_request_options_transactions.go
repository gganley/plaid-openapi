...
// SandboxPublicTokenCreateRequestOptionsTransactions SandboxPublicTokenCreateRequestOptionsTransactions is an optional set of corresponding to transactions options.
...
type _SandboxPublicTokenCreateRequestOptionsTransactions SandboxPublicTokenCreateRequestOptionsTransactions
...
func (o *SandboxPublicTokenCreateRequestOptionsTransactions) UnmarshalJSON(bytes []byte) (err error) {
	varSandboxPublicTokenCreateRequestOptionsTransactions := _SandboxPublicTokenCreateRequestOptionsTransactions{}

	if err = json.Unmarshal(bytes, &varSandboxPublicTokenCreateRequestOptionsTransactions); err == nil {
		*o = SandboxPublicTokenCreateRequestOptionsTransactions(varSandboxPublicTokenCreateRequestOptionsTransactions)
	}
