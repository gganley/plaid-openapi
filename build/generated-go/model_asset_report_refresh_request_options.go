...
type _AssetReportRefreshRequestOptions AssetReportRefreshRequestOptions
...
func (o *AssetReportRefreshRequestOptions) UnmarshalJSON(bytes []byte) (err error) {
	varAssetReportRefreshRequestOptions := _AssetReportRefreshRequestOptions{}

	if err = json.Unmarshal(bytes, &varAssetReportRefreshRequestOptions); err == nil {
		*o = AssetReportRefreshRequestOptions(varAssetReportRefreshRequestOptions)
	}
