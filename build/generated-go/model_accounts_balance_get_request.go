...
type _AccountsBalanceGetRequest AccountsBalanceGetRequest
...
func (o *AccountsBalanceGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varAccountsBalanceGetRequest := _AccountsBalanceGetRequest{}

	if err = json.Unmarshal(bytes, &varAccountsBalanceGetRequest); err == nil {
		*o = AccountsBalanceGetRequest(varAccountsBalanceGetRequest)
	}
