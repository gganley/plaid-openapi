...
type _BankTransferCancelRequest BankTransferCancelRequest
...
func (o *BankTransferCancelRequest) UnmarshalJSON(bytes []byte) (err error) {
	varBankTransferCancelRequest := _BankTransferCancelRequest{}

	if err = json.Unmarshal(bytes, &varBankTransferCancelRequest); err == nil {
		*o = BankTransferCancelRequest(varBankTransferCancelRequest)
	}
