...
type _ProcessorBalanceGetRequest ProcessorBalanceGetRequest
...
func (o *ProcessorBalanceGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varProcessorBalanceGetRequest := _ProcessorBalanceGetRequest{}

	if err = json.Unmarshal(bytes, &varProcessorBalanceGetRequest); err == nil {
		*o = ProcessorBalanceGetRequest(varProcessorBalanceGetRequest)
	}
