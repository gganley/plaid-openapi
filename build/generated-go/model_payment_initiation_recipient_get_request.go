...
type _PaymentInitiationRecipientGetRequest PaymentInitiationRecipientGetRequest
...
func (o *PaymentInitiationRecipientGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPaymentInitiationRecipientGetRequest := _PaymentInitiationRecipientGetRequest{}

	if err = json.Unmarshal(bytes, &varPaymentInitiationRecipientGetRequest); err == nil {
		*o = PaymentInitiationRecipientGetRequest(varPaymentInitiationRecipientGetRequest)
	}
