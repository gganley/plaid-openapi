...
type _InvestmentsTransactionsGetRequest InvestmentsTransactionsGetRequest
...
func (o *InvestmentsTransactionsGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varInvestmentsTransactionsGetRequest := _InvestmentsTransactionsGetRequest{}

	if err = json.Unmarshal(bytes, &varInvestmentsTransactionsGetRequest); err == nil {
		*o = InvestmentsTransactionsGetRequest(varInvestmentsTransactionsGetRequest)
	}
