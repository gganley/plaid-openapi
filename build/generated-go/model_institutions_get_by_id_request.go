...
type _InstitutionsGetByIdRequest InstitutionsGetByIdRequest
...
func (o *InstitutionsGetByIdRequest) UnmarshalJSON(bytes []byte) (err error) {
	varInstitutionsGetByIdRequest := _InstitutionsGetByIdRequest{}

	if err = json.Unmarshal(bytes, &varInstitutionsGetByIdRequest); err == nil {
		*o = InstitutionsGetByIdRequest(varInstitutionsGetByIdRequest)
	}
