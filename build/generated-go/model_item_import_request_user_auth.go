...
type _ItemImportRequestUserAuth ItemImportRequestUserAuth
...
func (o *ItemImportRequestUserAuth) UnmarshalJSON(bytes []byte) (err error) {
	varItemImportRequestUserAuth := _ItemImportRequestUserAuth{}

	if err = json.Unmarshal(bytes, &varItemImportRequestUserAuth); err == nil {
		*o = ItemImportRequestUserAuth(varItemImportRequestUserAuth)
	}
