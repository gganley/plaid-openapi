...
type _ProjectedIncomeSummaryFieldNumber ProjectedIncomeSummaryFieldNumber
...
func (o *ProjectedIncomeSummaryFieldNumber) UnmarshalJSON(bytes []byte) (err error) {
	varProjectedIncomeSummaryFieldNumber := _ProjectedIncomeSummaryFieldNumber{}

	if err = json.Unmarshal(bytes, &varProjectedIncomeSummaryFieldNumber); err == nil {
		*o = ProjectedIncomeSummaryFieldNumber(varProjectedIncomeSummaryFieldNumber)
	}
