...
type APR struct {
	...
	BalanceSubjectToApr NullableFloat32 `json:"balance_subject_to_apr,omitempty"`
	// Amount of money charged due to interest from last statement.
	InterestChargeAmount NullableFloat32 `json:"interest_charge_amount,omitempty"`
...
// GetBalanceSubjectToApr returns the BalanceSubjectToApr field value if set, zero value otherwise (both if not set or set to explicit null).
...
// GetBalanceSubjectToAprOk returns a tuple with the BalanceSubjectToApr field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o *APR) HasBalanceSubjectToApr() bool {
	if o != nil && o.BalanceSubjectToApr.IsSet() {
		return true
	}
...
// SetBalanceSubjectToApr gets a reference to the given NullableFloat32 and assigns it to the BalanceSubjectToApr field.
...
func (o *APR) UnsetBalanceSubjectToApr() {
	o.BalanceSubjectToApr.Unset()
}

// GetInterestChargeAmount returns the InterestChargeAmount field value if set, zero value otherwise (both if not set or set to explicit null).
...
// GetInterestChargeAmountOk returns a tuple with the InterestChargeAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
func (o *APR) HasInterestChargeAmount() bool {
	if o != nil && o.InterestChargeAmount.IsSet() {
		return true
	}
...
// SetInterestChargeAmount gets a reference to the given NullableFloat32 and assigns it to the InterestChargeAmount field.
...
func (o APR) MarshalJSON() ([]byte, error) {
	...
	if o.BalanceSubjectToApr.IsSet() {
		toSerialize["balance_subject_to_apr"] = o.BalanceSubjectToApr.Get()
	}
	if o.InterestChargeAmount.IsSet() {
