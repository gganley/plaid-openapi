...
/*
 * DepositSwitchAltCreate Create a deposit switch when not using Plaid Exchange.'
...
/*
 * IncomeVerificationPaystubGet Retrieve information from the paystub used for income verification
...
func (r ApiPostIncomeVerificationCreateRequest) IncomeVerificationCreateRequest(incomeVerificationCreateRequest IncomeVerificationCreateRequest) ApiPostIncomeVerificationCreateRequest {
	r.incomeVerificationCreateRequest = &incomeVerificationCreateRequest
	return r
}

func (r ApiPostIncomeVerificationCreateRequest) Execute() (IncomeVerificationCreateResponse, *_nethttp.Response, error) {
	return r.ApiService.PostIncomeVerificationCreateExecute(r)
}

/*
 * PostIncomeVerificationCreate Create an income verification instance
 ...
 */
func (a *PlaidApiService) PostIncomeVerificationCreateExecute(r ApiPostIncomeVerificationCreateRequest) (IncomeVerificationCreateResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaidApiService.PostIncomeVerificationCreate")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
