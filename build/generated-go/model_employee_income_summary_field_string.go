...
type _EmployeeIncomeSummaryFieldString EmployeeIncomeSummaryFieldString
...
func (o *EmployeeIncomeSummaryFieldString) UnmarshalJSON(bytes []byte) (err error) {
	varEmployeeIncomeSummaryFieldString := _EmployeeIncomeSummaryFieldString{}

	if err = json.Unmarshal(bytes, &varEmployeeIncomeSummaryFieldString); err == nil {
		*o = EmployeeIncomeSummaryFieldString(varEmployeeIncomeSummaryFieldString)
	}
