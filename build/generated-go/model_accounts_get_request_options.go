...
type _AccountsGetRequestOptions AccountsGetRequestOptions
...
func (o *AccountsGetRequestOptions) UnmarshalJSON(bytes []byte) (err error) {
	varAccountsGetRequestOptions := _AccountsGetRequestOptions{}

	if err = json.Unmarshal(bytes, &varAccountsGetRequestOptions); err == nil {
		*o = AccountsGetRequestOptions(varAccountsGetRequestOptions)
	}
