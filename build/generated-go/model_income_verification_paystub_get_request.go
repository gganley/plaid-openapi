...
type _IncomeVerificationPaystubGetRequest IncomeVerificationPaystubGetRequest
...
func (o *IncomeVerificationPaystubGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varIncomeVerificationPaystubGetRequest := _IncomeVerificationPaystubGetRequest{}

	if err = json.Unmarshal(bytes, &varIncomeVerificationPaystubGetRequest); err == nil {
		*o = IncomeVerificationPaystubGetRequest(varIncomeVerificationPaystubGetRequest)
	}
