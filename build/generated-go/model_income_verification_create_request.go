...
type _IncomeVerificationCreateRequest IncomeVerificationCreateRequest
...
func (o *IncomeVerificationCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varIncomeVerificationCreateRequest := _IncomeVerificationCreateRequest{}

	if err = json.Unmarshal(bytes, &varIncomeVerificationCreateRequest); err == nil {
		*o = IncomeVerificationCreateRequest(varIncomeVerificationCreateRequest)
	}
