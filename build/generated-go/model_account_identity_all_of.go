...
type _AccountIdentityAllOf AccountIdentityAllOf
...
func (o *AccountIdentityAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varAccountIdentityAllOf := _AccountIdentityAllOf{}

	if err = json.Unmarshal(bytes, &varAccountIdentityAllOf); err == nil {
		*o = AccountIdentityAllOf(varAccountIdentityAllOf)
	}
