...
type _EmployerIncomeSummaryFieldString EmployerIncomeSummaryFieldString
...
func (o *EmployerIncomeSummaryFieldString) UnmarshalJSON(bytes []byte) (err error) {
	varEmployerIncomeSummaryFieldString := _EmployerIncomeSummaryFieldString{}

	if err = json.Unmarshal(bytes, &varEmployerIncomeSummaryFieldString); err == nil {
		*o = EmployerIncomeSummaryFieldString(varEmployerIncomeSummaryFieldString)
	}
