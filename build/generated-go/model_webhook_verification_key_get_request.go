...
type _WebhookVerificationKeyGetRequest WebhookVerificationKeyGetRequest
...
func (o *WebhookVerificationKeyGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varWebhookVerificationKeyGetRequest := _WebhookVerificationKeyGetRequest{}

	if err = json.Unmarshal(bytes, &varWebhookVerificationKeyGetRequest); err == nil {
		*o = WebhookVerificationKeyGetRequest(varWebhookVerificationKeyGetRequest)
	}
