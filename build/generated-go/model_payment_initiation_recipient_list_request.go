...
type _PaymentInitiationRecipientListRequest PaymentInitiationRecipientListRequest
...
func (o *PaymentInitiationRecipientListRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPaymentInitiationRecipientListRequest := _PaymentInitiationRecipientListRequest{}

	if err = json.Unmarshal(bytes, &varPaymentInitiationRecipientListRequest); err == nil {
		*o = PaymentInitiationRecipientListRequest(varPaymentInitiationRecipientListRequest)
	}
