...
type _AssetReportPDFGetRequest AssetReportPDFGetRequest
...
func (o *AssetReportPDFGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varAssetReportPDFGetRequest := _AssetReportPDFGetRequest{}

	if err = json.Unmarshal(bytes, &varAssetReportPDFGetRequest); err == nil {
		*o = AssetReportPDFGetRequest(varAssetReportPDFGetRequest)
	}
