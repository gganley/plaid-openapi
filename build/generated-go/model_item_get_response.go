...
// SetStatus gets a reference to the given NullableItemStatus and assigns it to the Status field.
...
// SetAccessToken gets a reference to the given NullableNullableAccessToken and assigns it to the AccessToken field.
