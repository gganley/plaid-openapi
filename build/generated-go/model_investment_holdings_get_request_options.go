...
type _InvestmentHoldingsGetRequestOptions InvestmentHoldingsGetRequestOptions
...
func (o *InvestmentHoldingsGetRequestOptions) UnmarshalJSON(bytes []byte) (err error) {
	varInvestmentHoldingsGetRequestOptions := _InvestmentHoldingsGetRequestOptions{}

	if err = json.Unmarshal(bytes, &varInvestmentHoldingsGetRequestOptions); err == nil {
		*o = InvestmentHoldingsGetRequestOptions(varInvestmentHoldingsGetRequestOptions)
	}
