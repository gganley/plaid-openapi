...
type _BankTransferCreateRequest BankTransferCreateRequest
...
func (o *BankTransferCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varBankTransferCreateRequest := _BankTransferCreateRequest{}

	if err = json.Unmarshal(bytes, &varBankTransferCreateRequest); err == nil {
		*o = BankTransferCreateRequest(varBankTransferCreateRequest)
	}
