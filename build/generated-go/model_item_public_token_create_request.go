...
type _ItemPublicTokenCreateRequest ItemPublicTokenCreateRequest
...
func (o *ItemPublicTokenCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varItemPublicTokenCreateRequest := _ItemPublicTokenCreateRequest{}

	if err = json.Unmarshal(bytes, &varItemPublicTokenCreateRequest); err == nil {
		*o = ItemPublicTokenCreateRequest(varItemPublicTokenCreateRequest)
	}
