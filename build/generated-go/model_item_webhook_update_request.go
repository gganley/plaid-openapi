...
type _ItemWebhookUpdateRequest ItemWebhookUpdateRequest
...
func (o *ItemWebhookUpdateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varItemWebhookUpdateRequest := _ItemWebhookUpdateRequest{}

	if err = json.Unmarshal(bytes, &varItemWebhookUpdateRequest); err == nil {
		*o = ItemWebhookUpdateRequest(varItemWebhookUpdateRequest)
	}
