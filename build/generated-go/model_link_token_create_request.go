...
type _LinkTokenCreateRequest LinkTokenCreateRequest
...
func (o *LinkTokenCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varLinkTokenCreateRequest := _LinkTokenCreateRequest{}

	if err = json.Unmarshal(bytes, &varLinkTokenCreateRequest); err == nil {
		*o = LinkTokenCreateRequest(varLinkTokenCreateRequest)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "android_package_name")
		delete(additionalProperties, "account_filters")
		delete(additionalProperties, "institution_id")
		delete(additionalProperties, "payment_initiation")
		delete(additionalProperties, "deposit_switch")
