...
type _AssetReportFilterRequest AssetReportFilterRequest
...
func (o *AssetReportFilterRequest) UnmarshalJSON(bytes []byte) (err error) {
	varAssetReportFilterRequest := _AssetReportFilterRequest{}

	if err = json.Unmarshal(bytes, &varAssetReportFilterRequest); err == nil {
		*o = AssetReportFilterRequest(varAssetReportFilterRequest)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "account_ids_to_exclude")
