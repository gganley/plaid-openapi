...
type _SandboxProcessorTokenCreateRequest SandboxProcessorTokenCreateRequest
...
func (o *SandboxProcessorTokenCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varSandboxProcessorTokenCreateRequest := _SandboxProcessorTokenCreateRequest{}

	if err = json.Unmarshal(bytes, &varSandboxProcessorTokenCreateRequest); err == nil {
		*o = SandboxProcessorTokenCreateRequest(varSandboxProcessorTokenCreateRequest)
	}
