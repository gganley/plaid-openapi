...
type _BankTransferBalanceGetRequest BankTransferBalanceGetRequest
...
func (o *BankTransferBalanceGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varBankTransferBalanceGetRequest := _BankTransferBalanceGetRequest{}

	if err = json.Unmarshal(bytes, &varBankTransferBalanceGetRequest); err == nil {
		*o = BankTransferBalanceGetRequest(varBankTransferBalanceGetRequest)
	}
