...
type _SandboxItemResetLoginRequest SandboxItemResetLoginRequest
...
func (o *SandboxItemResetLoginRequest) UnmarshalJSON(bytes []byte) (err error) {
	varSandboxItemResetLoginRequest := _SandboxItemResetLoginRequest{}

	if err = json.Unmarshal(bytes, &varSandboxItemResetLoginRequest); err == nil {
		*o = SandboxItemResetLoginRequest(varSandboxItemResetLoginRequest)
	}
