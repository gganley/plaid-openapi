...
type _InstitutionsSearchRequest InstitutionsSearchRequest
...
func (o *InstitutionsSearchRequest) UnmarshalJSON(bytes []byte) (err error) {
	varInstitutionsSearchRequest := _InstitutionsSearchRequest{}

	if err = json.Unmarshal(bytes, &varInstitutionsSearchRequest); err == nil {
		*o = InstitutionsSearchRequest(varInstitutionsSearchRequest)
	}
