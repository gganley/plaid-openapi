...
type _ItemPublicTokenExchangeRequest ItemPublicTokenExchangeRequest
...
func (o *ItemPublicTokenExchangeRequest) UnmarshalJSON(bytes []byte) (err error) {
	varItemPublicTokenExchangeRequest := _ItemPublicTokenExchangeRequest{}

	if err = json.Unmarshal(bytes, &varItemPublicTokenExchangeRequest); err == nil {
		*o = ItemPublicTokenExchangeRequest(varItemPublicTokenExchangeRequest)
	}
